          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row" >
              <div class="form__counter">
                <button type="button" v-on:click.prevent="productsAmount-=1" aria-label="Убрать один товар">
                ...
                <button type="button" @click.prevent="productsAmount++" aria-label="Добавить один товар">
                  <svg width="12" height="12" fill="currentColor">
...
import gotoPage from '@/helperst/gotoPage';
import numberFormat from '@/helperst/numberFormat';
...
export default {
    ...
    methods:{
     ...
     addToCart(){
        this.$store.commit(
          'addProductsToCart',
           {productId: this.product.id, amount: this.productsAmount}
        );
     },
    }
}
